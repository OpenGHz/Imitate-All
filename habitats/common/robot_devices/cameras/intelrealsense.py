...
class IntelRealSenseCamera:
    ...
    ```bash
    python habitats/common/robot_devices/cameras/intelrealsense.py --images-dir outputs/images_from_intelrealsense_cameras
    ```
        ...
        if not is_camera_open:
            ...
            if self.camera_index not in available_cam_ids:
                raise ValueError(
                    ...
                    "To find the camera index you should use, run `python habitats/common/robot_devices/cameras/intelrealsense.py`."
                )
