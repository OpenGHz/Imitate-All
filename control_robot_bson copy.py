...
import numpy as np
from airbot_data.io import save_bson,load_bson,save_actraw
    ...
    with concurrent.futures.ThreadPoolExecutor(
        ...
        while episode_index < num_episodes:
            ...
            while timestamp < episode_time_s:
                ...
                print(f"时间 1：{time.perf_counter() - start_loop_t}")
                # show current images
                ...
                if not is_headless():
                    ...
                    # cv2.waitKey(1)
                    RealTimeDisplay.waitKey(1)
                print(f"时间2 ：{time.perf_counter() - start_loop_t}")
                ...
                print(f"时间3 ：{time.perf_counter() - start_loop_t}")
                frame_index += 1
            ...
            # bson_data = load_bson("episode_0.bson")
            bson_data = load_bson(episodes_dir / f"episode_{episode_index}.bson")
            save_actraw(bson_data, episodes_dir / "output/actraw") 
            # save record informationa
            rec_info = {
